...
/* Javascript - Mostrar gaveta do carrinho quando o produto é adicionado ao carrinho */
document.addEventListener('theme:cart:popdown', (e) => {
const listener = (e) => {
...
document.removeEventListener('theme:cart:change', ouvinte);
};
document.addEventListener('theme:cart:change', ouvinte);
});
/*fim*/
